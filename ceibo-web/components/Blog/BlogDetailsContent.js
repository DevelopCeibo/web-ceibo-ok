	...
	const renderContent = (content) => {
		return content?.map((el, i) => {
			switch (el.type) {
				case "img":
					return (
						<img src={el.src} style={{ maxWidth: el.maxWidth }} />
					);
					break;
				case "first-p":
					return (
                  ...
                  <img src={publicacion.metadata.bannerImg} alt="image" />
                    ...
                    <li>
                      ...
                      2022
									...
									{/* Category */}
									{publicacion?.metadata?.author?.length >=
										1 && publicacion.metadata.author[0] ? (
